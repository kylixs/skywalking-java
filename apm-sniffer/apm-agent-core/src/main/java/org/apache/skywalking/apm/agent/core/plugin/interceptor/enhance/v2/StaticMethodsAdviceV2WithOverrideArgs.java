...
public class StaticMethodsAdviceV2WithOverrideArgs {
    ...
    public static Object[] enter(@Advice.Origin Class<?> clazz,
        ...
        Object[] objects = StaticMethodsAdviceV2.onEnter(clazz, method, args, INTERCEPTOR_CLASS);
        // inline change args
        allArguments = args;
        return objects;
    }
    ...
    public static void exit(@Advice.Origin Class<?> clazz,
        ...
        returnObj = StaticMethodsAdviceV2.onExit(clazz, method, allArguments, throwable, returnObj, (MethodInvocationContext) contexts[0], INTERCEPTOR_CLASS);
    }
