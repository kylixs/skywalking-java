...
public class InstanceMethodsAdviceV2WithOverrideArgs {
    ...
    public static Object[] enter(@Advice.This Object objInst,
        ...
        Object[] objects = InstanceMethodsAdviceV2.onEnter((EnhancedInstance) objInst, method, allArguments, INTERCEPTOR_CLASS);
        // inline change args
        allArguments = args;
        return objects;
    }
    ...
    public static void exit(@Advice.This Object objInst,
        ...
        returnObj = InstanceMethodsAdviceV2.onExit((EnhancedInstance) objInst, method, allArguments, throwable, returnObj, (MethodInvocationContext) contexts[0], INTERCEPTOR_CLASS);
    }
