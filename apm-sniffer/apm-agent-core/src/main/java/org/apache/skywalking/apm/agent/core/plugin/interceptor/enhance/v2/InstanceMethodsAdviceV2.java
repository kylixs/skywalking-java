...
public class InstanceMethodsAdviceV2 {

    public static final String INTERCEPTOR_CLASS = "INTERCEPTOR_CLASS";

    private static final ILog LOGGER = LogManager.getLogger(InstanceMethodsAdviceV2.class);
    ...
    public static void exit(@Advice.This Object objInst,
        ...
        returnObj = onExit((EnhancedInstance) objInst, method, allArguments, throwable, returnObj, (MethodInvocationContext) contexts[0], INTERCEPTOR_CLASS);
    }
    ...
    public static Object[] onEnter(EnhancedInstance objInst, Method method, Object[] allArguments, String interceptorClass) throws Exception {
        ...
        InstanceMethodsAroundInterceptorV2 interceptor = InterceptorInstanceLoader.load(interceptorClass, clazz
                .getClassLoader());
        MethodInvocationContext context = new MethodInvocationContext();

        try {
            interceptor.beforeMethod(objInst, method, allArguments, method.getParameterTypes(), context);
        } catch (Throwable t) {
    ...
    public static Object onExit(EnhancedInstance objInst, Method method, Object[] allArguments, Throwable throwable, Object returnObj,
                                MethodInvocationContext context, String interceptorClass) throws Exception {
        Class<?> clazz = objInst.getClass();
        InstanceMethodsAroundInterceptorV2 interceptor = InterceptorInstanceLoader.load(interceptorClass, clazz
                .getClassLoader());
        ...
        if (throwable != null) {
            try {
                interceptor.handleMethodException(objInst, method, allArguments, method.getParameterTypes(), throwable, context);
            } catch (Throwable t2) {
        ...
        try {
            returnObj = interceptor.afterMethod(objInst, method, allArguments, method.getParameterTypes(), returnObj, context);
        } catch (Throwable t) {
